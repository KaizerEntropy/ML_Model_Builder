export const imageDatasets = [
  ...
  { category: "Skin Cancer", name: "ISIC 2018", classes: 7, size: "10,015 images", shape: [224, 224, 3], url: "https://challenge.isic-archive.com/data/#2018", compatible: "cnn/transformer/unet" },
  { category: "Skin Cancer", name: "ISIC 2017", classes: 3, size: "2,000 images", shape: [224, 224, 3], url: "https://challenge.isic-archive.com/data/#2017", compatible: "cnn/transformer/unet" },
  ...
  { category: "Skin Cancer", name: "Milk10k", classes: 2, size: "10,000 images", shape: [224, 224, 3], url: "#", compatible: "cnn/transformer/unet" },
  ...
  { category: "Blood Classifications", name: "RaabinWBC", classes: 5, size: "1,145 images", shape: [224, 224, 3], url: "https://raabin.iau.ir/wbc/", compatible: "cnn/transformer/unet" },
  ...
  { category: "Breast Cancer", name: "BACH", classes: 4, size: "400 images", shape: [224, 224, 3], url: "https://iciar2018-challenge.grand-challenge.org/", compatible: "cnn/transformer/unet" },
  ...
  /* Chest XRay */
  { category: "Chest XRay", name: "NIH Chest X-ray", classes: 14, size: "112,120 images", shape: [224, 224, 1], url: "https://nihcc.app.box.com/v/ChestXray-NIHCC", compatible: "cnn/transformer/unet" },
  { category: "Chest XRay", name: "MosMed", classes: 2, size: "1,110 images", shape: [224, 224, 1], url: "https://mosmed.ai/datasets/covid19_1110", compatible: "cnn/transformer/unet" },
  { category: "Chest XRay", name: "QaTa-COV19", classes: 2, size: "6,200 images", shape: [224, 224, 1], url: "https://www.kaggle.com/datasets/aysendegerli/qatacov19-dataset", compatible: "cnn/transformer/unet" },
